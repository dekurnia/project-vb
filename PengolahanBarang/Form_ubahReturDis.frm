...
Begin VB.Form Form_ubahReturDis 
   BackColor       =   &H00FFFFFF&
   ...
   EndProperty
   ForeColor       =   &H00000000&
   Icon            =   "Form_ubahReturDis.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   8295
   ...
   Begin VB.CommandButton cmdKELUAR 
      ...
      Height          =   855
      Left            =   12120
      Picture         =   "Form_ubahReturDis.frx":57E2
      Style           =   1  'Graphical
      TabIndex        =   16
      Top             =   7200
      Width           =   1095
   ...
   Begin VB.Frame Frame_iden 
      ...
      Begin VB.Image Image1 
         Height          =   480
         Left            =   2280
         Picture         =   "Form_ubahReturDis.frx":5E77
         Stretch         =   -1  'True
         ToolTipText     =   "Find"
         Top             =   840
         Width           =   480
   ...
   Begin VB.Image tbTambah 
      Height          =   495
      Left            =   11400
      Picture         =   "Form_ubahReturDis.frx":6181
      Stretch         =   -1  'True
      ToolTipText     =   "Tambah"
      Top             =   3000
      Width           =   480
   ...
   Begin VB.Image TbHapus 
      Height          =   480
      Left            =   12600
      Picture         =   "Form_ubahReturDis.frx":6709
      ToolTipText     =   "Hapus"
      Top             =   3000
      Width           =   480
   End
   Begin VB.Image TbUbah 
      Height          =   480
      Left            =   12000
      Picture         =   "Form_ubahReturDis.frx":734D
      Stretch         =   -1  'True
      ToolTipText     =   "Ubah"
      Top             =   3000
      Width           =   480
   End
End
Attribute VB_Name = "Form_ubahReturDis"
...
Private Sub ambil_nilai()
    Dim kode As String
    kode = Form_LihatReturDis.txtkode.Text
    
    Query = "Select tbtmpretursup1.*,tbdistributor.namadistributor " _
            & " from tbtmpretursup1,tbdistributor " _
            & " where tbtmpretursup1.kdDistributor=tbdistributor.kddistributor " _
            & "  and tbtmpretursup1.kdretursup='" & kode & "'"
            Set rs_TERIMA = koneksi.Execute(Query)
      If Not rs_TERIMA.EOF Then
         txttglbukti.Text = nvl(Format(rs_TERIMA("tglretur"), "yyyy-mm-dd"), "")
         txtKodeDist.Text = nvl(rs_TERIMA("kddistributor"), "")
         txtkodeBukti.Text = nvl(rs_TERIMA("kdretursup"), "")
         txtDist.Text = nvl(rs_TERIMA("namadistributor"), "")
    End If
    frame_iden.Enabled = False
    Call TampilGridRetur
End Sub
